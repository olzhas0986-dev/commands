...
git clone https://github.com/olzhas0986-dev/device_xiaomi_munch.git device/xiaomi/munch; \
...
git clone https://github.com/olzhas0986-dev/vendor_xiaomi_sm8250-common vendor/xiaomi/sm8250-common; \
git clone https://github.com/olzhas0986-dev/android_hardware_xiaomi hardware/xiaomi; \
